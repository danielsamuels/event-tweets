...
var staticFolder = 'event_tweets/static/';
var templateFolder = 'event_tweets/templates/';
...
gulp.task('bowerFiles', function() {
    gulp.src([
        ...
        .pipe(gulp.dest('event_tweets/static/js/vendor/'));


    gulp.src('bower_components/foundation/js/foundation/*')
        .pipe(gulp.dest('event_tweets/static/js/vendor/foundation/'));
    ...
    gulp.src([
        ...
        .pipe(gulp.dest('event_tweets/static/scss/'));
